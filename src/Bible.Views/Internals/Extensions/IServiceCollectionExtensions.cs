...
internal static class IServiceCollectionExtensions
{
    ...
    /// <summary>
    /// <see cref="ServiceLifetime.Transient" /> 인 Service 들을 등록합니다.
    /// </summary>
    /// <param name="services"> <see cref="IServiceCollection" /> 의 구현체입니다. </param>
    /// <returns> <see cref="ServiceLifetime.Transient" /> 인 Service 들을 <see cref="IServiceCollection" /> 구현체에 등록 후 <see cref="IServiceCollection" /> 을 반환합니다. </returns>
